...
public interface EquipoRepository extends JpaRepository<Equipo, Long>{
    ...
    @Query("select jugador.nombre, max(jugador.canastas) from Jugador jugador where jugador.equipo.nombre is :nombre")
    List<Object[]> findJugadorMaxCanastasByEquipo(@Param("nombre") String nombre);
}
